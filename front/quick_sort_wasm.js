...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'quick_sort_wasm.wast';
  var wasmBinaryFile = 'quick_sort_wasm.wasm';
  var asmjsCodeFile = 'quick_sort_wasm.temp.asm.js';
...
var real__launch_sort = asm["_launch_sort"]; asm["_launch_sort"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__launch_sort.apply(null, arguments);
};
...
var _launch_sort = Module["_launch_sort"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_launch_sort"].apply(null, arguments) };
